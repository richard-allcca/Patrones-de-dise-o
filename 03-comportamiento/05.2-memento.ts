...
function main(): void {
  ...
  history.push(drawingBoard.captureWhiteboardState());

  drawingBoard.addShape('Cuadrado');
  history.push(drawingBoard.captureWhiteboardState());

  drawingBoard.addShape('Triángulo');
  drawingBoard.showCurrentBoard(); // Mostrar estado actual de la pizarra

  // Deshacer el último cambio
  drawingBoard.restore(history.pop()!);
  drawingBoard.showCurrentBoard(); // Mostrar estado después de deshacer

  // Deshacer otro cambio
  drawingBoard.restore(history.pop()!);
  drawingBoard.showCurrentBoard(); // Mostrar estado después de deshacer nuevamente
...
// Logs:
// Figura agregada: Círculo
// Figura agregada: Cuadrado
// Figura agregada: Triángulo
// Pizarra actual: Círculo, Cuadrado, Triángulo

// Estado de la pizarra restaurado.
// Pizarra actual: Círculo, Cuadrado

// Estado de la pizarra restaurado.
// Pizarra actual: Círculo