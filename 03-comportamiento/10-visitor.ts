...
class ChildVisitor implements Visitor {
  visitRollerCoaster(rollerCoaster: RollerCoaster): void {
    // El niño tiene un descuento de 50% en la montaña rusa
    // El precio original es de $50, por lo que el precio con descuento es de $25
    console.log(
  ...
  visitHauntedHouse(hauntedHouse: HauntedHouse): void {
    // El niño tiene un descuento de 30% en la casa del terror
    // El precio original es de $40, por lo que el precio con descuento es de $28
    console.log(
  ...
  visitFerrisWheel(ferrisWheel: FerrisWheel): void {
    // El niño tiene un descuento de 40% en la rueda de la fortuna
    // El precio original es de $30, por lo que el precio con descuento es de $18
    console.log(
