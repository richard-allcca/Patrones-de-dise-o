...
/**
 * * Dispositivos
 * * En este caso, los dispositivos son la luz y el ventilador.
 */
...
/**
 * * * Comandos
 * * En este caso, los comandos son encender y apagar la luz y el ventilador.
 */
...
/**
 * * Control Remoto
 * * En este caso, el control remoto es el que invoca los comandos.
 * * Se puede asignar un comando a un botón y luego presionar el botón para ejecutar el comando.
 */
...
/**
 * * Main
 * * En este caso, el main es el que crea los objetos y los comandos.
 * * Se puede asignar un comando a un botón y luego presionar el botón para ejecutar el comando.
 * * Se puede seguir presionando botones hasta que se decida salir.
 */
function main() {
