...
class SalesReport implements Report {
  generate(): void {
    console.log('%cGenerando Sales Report...', COLORS.cyan);
...
class InventoryReport implements Report {
  generate(): void {
    console.log('%cGenerando Inventory Report...', COLORS.orange);
    // Lógica para generar el reporte de invent
  }
}
...
//! 4. Concrete Creators - subclases de ReportFactory
