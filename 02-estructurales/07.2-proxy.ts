...
/**
 * * En este ejemplo, tenemos un sistema de gestión de documentos
 * * que permite a los usuarios acceder a documentos confidenciales.
 * * El patrón Proxy se utiliza para controlar el acceso a los documentos
 * * y verificar si el usuario tiene los permisos necesarios para verlos.
 */
