...
/**
 * * En este ejemplo, tenemos un sistema de computadora que consta de varios
 * * componentes: CPU, memoria y disco duro. El patrón Facade se utiliza para
 * * simplificar la interacción con estos componentes al proporcionar una
 * * interfaz unificada para el cliente.
 */

// ===================================================
// Definimos las clases para cada componente del sistema de computadora
...
// ===================================================
// Definimos la clase Facade que simplifica la interacción con los componentes
